        ...
        <div className='container lg:px-28'>
            <div className='w-full px-4'>
                <div className='max-w-xl mx-auto text-center mb-16'>
                    <h4 className='font-semibold text-lg text-main mb-2 uppercase'>Blog</h4>
                ...
                <div className='w-full px-4 lg:w-1/2 xl:w-1/3'>
                    <div className='bg-white rounded-xl shadow-lg overflow-hidden mb-10'>
                        ...
                        <div className='py-8 px-6'>
                            <h3>
                                <a href="#" className='block mb-3 font-semibold text-xl text-dark hover:text-main truncate'>Tips belajar Programing</a>
                            </h3>
                            ...
                            <a href="#" className='font-medium text-sm text-white bg-main py-2 px-4 rounded-lg hover:opacity-80 '>Baca Selengkapnya</a>
                        </div>
                    </div>
                </div>
                <div className='w-full px-4 lg:w-1/2 xl:w-1/3'>
