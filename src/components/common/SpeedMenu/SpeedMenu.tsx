...
<div data-dial-init className="fixed end-6 bottom-6 group">
    <div id="speed-dial-menu-click" className={`${open ? "flex" : "hidden"} flex-col items-center mb-4 space-y-2`}>
    ...
    type="button" data-dial-toggle="speed-dial-menu-click" data-dial-trigger="click" aria-controls="speed-dial-menu-click" aria-expanded="false" className="flex items-center justify-center text-white bg-blue-700 rounded-full w-14 h-14 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
