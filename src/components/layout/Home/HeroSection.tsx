    ...
    <div className='container lg:px-28'>
      <div className='flex flex-col md:flex-row justify-between items-center md:hidden'>
        ...
        <div className='w-full px-4 mt-10'>
          <h1 className='text-base font-semibold text-main md:text-xl'>Hallo Semua 👋, saya
          ...
          <a href="#" className='text-base font-semibold text-white bg-main py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out'>Hubungi saya</a>
        </div>
      </div>
